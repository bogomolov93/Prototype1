...

{
    ...
    protected function trim_file_name($file_path, $name, $size, $type, $error,
            $index, $content_range) {
            global $hn,$iscom,$new_hn,$dbConnection;
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $this->set_additional_file_properties($file);
                     		...
                     		$stmt = $dbConnection->prepare('insert into files 
 		(ticket_hash, original_name, file_hash, file_type, file_size, file_ext, is_commet, hash_comment) values 
 		(:ticket_hash, :original_name, :file_hash, :file_type, :file_size, :file_ext, :is_commet, :hash_com)');
		$stmt->execute(array(
	    ':is_commet'    =>$iscom,
		':ticket_hash'	=>$hn, 
