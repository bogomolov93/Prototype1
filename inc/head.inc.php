...
<body>
<link rel="stylesheet" href="<?=$CONF['hostname']?>css/bootstrap.min.css" />
<link rel="stylesheet" href="<?=$CONF['hostname']?>css/font-awesome.min.css">
<link rel="<?=$CONF['hostname']?>css/bootstrap-datetimepicker.css" rel="stylesheet">
<script src="<?=$CONF['hostname']?>js/jquery.maskedinput-1.2.2.js"></script>
<script src="<?=$CONF['hostname']?>js/jquery-2.1.1.min.js"></script>
<script src="<?=$CONF['hostname']?>js/bootstrap.min.js"></script>
<script src="<?=$CONF['hostname']?>js/moment-with-locales.js"></script>
<script src="<?=$CONF['hostname']?>js/bootstrap-datetimepicker.js"></script>
...
<link rel="stylesheet" href="<?=$CONF['hostname']?>css/font-awesome.min.css">
<link rel="stylesheet" href="<?=$CONF['hostname']?>css/w3.css">
...
<link rel="stylesheet" href="<?=$CONF['hostname']?>/s/s2/select2.css?v2">
